<template>
  <main class="relative w-screen h-full overflow-hidden">
    <div class="relative">
      <img
      ...
      <div
        class="absolute top-1/2 px-[5%] transform -translate-y-1/2 insert-0 flex flex-col justify-center items-center gap-8"
      >
